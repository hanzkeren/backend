...
export interface TournamentCreationAttributes extends Optional<TournamentAttributes, 'id' | 'createdAt' | 'updatedAt' | 'description' | 'status' | 'maxParticipants' | 'registrationDeadline' | 'rules' | 'prizeInfo'> {}
